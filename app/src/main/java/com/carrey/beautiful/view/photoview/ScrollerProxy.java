...
public abstract class ScrollerProxy {
    ...
    public static ScrollerProxy getScroller(Context context) {
        /*
         * if (VERSION.SDK_INT < VERSION_CODES.GINGERBREAD) { return new PreGingerScroller(context);
         * } else { return new GingerScroller(context); }
         */
    ...
    /*
     * @TargetApi(9) private static class GingerScroller extends ScrollerProxy {
     * 
     ...
     * 
     * @Override public void fling(int startX, int startY, int velocityX, int velocityY, int minX,
     * int maxX, int minY, int maxY, int overX, int overY) { mScroller.fling(startX, startY,
     * velocityX, velocityY, minX, maxX, minY, maxY, overX, overY); }
     * 
     * @Override public void forceFinished(boolean finished) { mScroller.forceFinished(finished); }
     * 
     * @Override public int getCurrX() { return mScroller.getCurrX(); }
     * 
